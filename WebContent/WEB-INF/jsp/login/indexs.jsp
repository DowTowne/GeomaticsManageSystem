					...
					<ul class="nav ace-nav">
						<li class="light-blue">
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li class="divider"></li>
								<li>
									<a href="login_tuichu.do" id="Exit_system"><i class="icon-off"></i>退出</a>
								</li>
							</ul>
						</li>
				...
				<div class="sidebar" id="sidebar">
					...
					<div id="menu_style" class="menu_style">
						<ul class="nav nav-list" id="nav_list">
							<li class="home">
								<a href="javascript:void(0)" name="notice_list.do" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 通知管理 </span></a>
							</li>
							<li>
								<a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 用户管理 </span><b class="arrow icon-angle-down"></b></a>
								<ul class="submenu">
									<li class="home">
							...
							<c:if test="${role != 'xs'}">
								<li>
									<a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 实验室管理 </span><b class="arrow icon-angle-down"></b></a>
									<ul class="submenu">
							...
							<c:if test="${role != 'xs'}">
								<li>
									<a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 职工管理 </span><b class="arrow icon-angle-down"></b></a>
									<ul class="submenu">
										<c:if test="${role == 'admin'}">
											<li class="home">
												<a href="javascript:void(0)" name="staff_list.do" title="职工列表" class="iframeurl">
													<i class="icon-double-angle-right"></i>职工管理</a>
											</li>
										</c:if>
							...
							<c:if test="${role != 'xs'}">
								<li>
									<a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 测区管理 </span><b class="arrow icon-angle-down"></b></a>
									<ul class="submenu">
										<c:if test="${role == 'admin'}">
											<li class="home">
							...
							<c:if test="${role == 'admin'}">
								...
								<li>
									<a href="#" class="dropdown-toggle"><i class="icon-cogs"></i><span class="menu-text"> 设备管理 </span><b class="arrow icon-angle-down"></b></a>
									<ul class="submenu">
										<li class="home">
											<a href="javascript:void(0)" name="equipment_list.do" title="技术参数管理" class="iframeurl"><i class="icon-double-angle-right"></i>技术参数管理</a>
										</li>
										<li class="home">
											<a href="javascript:void(0)" name="equipment_dataList.do" title="运行数据管理" class="iframeurl"><i class="icon-double-angle-right"></i>运行数据管理</a>
										</li>
										<li class="home">
											<a href="javascript:void(0)" name="equipment_dataList2.do" title="电子文档管理" class="iframeurl"><i class="icon-double-angle-right"></i>电子文档管理</a>
										</li>
									</ul>
								</li>
							</c:if>
							<c:if test="${role == 'admin'}">
								<li>
									<a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 设备维修管理 </span><b class="arrow icon-angle-down"></b></a>
									<ul class="submenu">
										<li class="home">
											<a href="javascript:void(0)" name="repair_repairlist.do" title="设备维修管理" class="iframeurl"><i class="icon-double-angle-right"></i>设备维修管理</a>
										</li>
										<li class="home">
											<a href="javascript:void(0)" name="repair_list.do" title="设备报修日志" class="iframeurl"><i class="icon-double-angle-right"></i>设备报修日志</a>
										</li>
									</ul>
								</li>
							</c:if>
							<li>
								<a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 设备借用管理 </span><b class="arrow icon-angle-down"></b></a>
								<ul class="submenu">
									<li class="home">
										<a href="javascript:void(0)" name="equipment_dataList3.do" title="设备借用管理" class="iframeurl"><i class="icon-double-angle-right"></i>设备借用管理</a>
									</li>
									<c:if test="${role == 'admin'}">
										<li class="home">
											<a href="javascript:void(0)" name="equipmentlog_list.do" title="设备借用日志" class="iframeurl"><i class="icon-double-angle-right"></i>设备借用日志</a>
										</li>
									</c:if>
								</ul>
							</li>
