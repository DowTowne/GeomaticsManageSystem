...
Date: 2019-04-17 16:09:52
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for type_of_equipment_status
-- ----------------------------
DROP TABLE IF EXISTS `type_of_equipment_status`;
CREATE TABLE `type_of_equipment_status` (
...
-- ----------------------------
-- Records of type_of_equipment_status
-- ----------------------------
INSERT INTO `type_of_equipment_status` VALUES ('0', '闲置', '0');
INSERT INTO `type_of_equipment_status` VALUES ('1', '在用', '0');
INSERT INTO `type_of_equipment_status` VALUES ('2', '已损坏，待报废', '0');
INSERT INTO `type_of_equipment_status` VALUES ('3', '已报废', '0');

-- ----------------------------
-- Table structure for type_of_staff_status
-- ----------------------------
DROP TABLE IF EXISTS `type_of_staff_status`;
CREATE TABLE `type_of_staff_status` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
-- ----------------------------
-- Records of type_of_staff_status
-- ----------------------------
INSERT INTO `type_of_staff_status` VALUES ('0', '离职', '0');
INSERT INTO `type_of_staff_status` VALUES ('1', '在职', '0');
INSERT INTO `type_of_staff_status` VALUES ('2', '实习', '0');
INSERT INTO `type_of_staff_status` VALUES ('3', '借调', '0');
...
CREATE TABLE `t_equipment` (
  ...
  CONSTRAINT `t_equipment_ibfk_1` FOREIGN KEY (`status_id`) REFERENCES `type_of_equipment_status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_equipment
-- ----------------------------
INSERT INTO `t_equipment` VALUES ('1', '11', '0', '0', '11', '11', null, '测试', '11', '6', '2016-11-17 09:32:29', '\\upload\\75b40810ad5f11e6779fd863d0b032aa实时位置和轨迹接口.doc', '1', '\\upload\\63cfd790ad6011e6779fd863d0b032aa13.jpg', '9', '1', '9', '6', '1');
INSERT INTO `t_equipment` VALUES ('2', '22', '0', '0', '222', '22', null, '222', '22', '7', '2016-11-17 09:58:57', '\\upload\\fe25ef90ae2911e6f233742beffe859a实验室设备管理系统详细功能.docx', '1', '\\upload\\20b2c030ad6011e6779fd863d0b032aa9.jpg', '7', '0', '11', '1', '0');
INSERT INTO `t_equipment` VALUES ('3', '33', '0', '0', '33', '33', null, '33', '33', '5', '2016-11-17 09:59:23', null, '1', '\\upload\\1e96d640ae2a11e6f233742beffe859a9.jpg', null, '1', '12', '6', '1');
INSERT INTO `t_equipment` VALUES ('4', '44', '0', '0', '44', '44', null, '44', '44', '5', '2016-11-17 09:27:33', null, '1', null, null, '0', '10', '4', '1');
INSERT INTO `t_equipment` VALUES ('5', '55', '0', '0', '55', '55', null, '55', '55', '6', '2016-11-19 15:30:34', null, '1', null, null, '0', null, null, '1');
INSERT INTO `t_equipment` VALUES ('6', '66', '0', '0', '666', '66', null, '666', '666', '6', null, null, '0', null, null, '0', null, null, '1');
INSERT INTO `t_equipment` VALUES ('7', '77', '0', '0', '77', '77', null, '777', '77', '3', null, null, '0', null, null, '0', null, null, '1');
INSERT INTO `t_equipment` VALUES ('8', '88', '0', '0', '88', '88', null, '88', '88', '4', '2016-11-19 16:11:48', null, '1', null, null, '0', null, null, '1');
INSERT INTO `t_equipment` VALUES ('9', '99', '0', '1', '99', '99', null, '99', '99', '7', null, null, '0', null, null, '0', null, null, '1');
INSERT INTO `t_equipment` VALUES ('10', '333', '0', '0', '222', '333', null, '测试测试', '测试测试', '9', '2016-11-19 15:31:11', null, '1', null, null, '0', null, null, '2');
INSERT INTO `t_equipment` VALUES ('11', '实验室管理测试', '0', '0', '11', '222', null, '实验室管理测试', '实验室管理测试', '10', '2016-11-19 15:47:05', '\\upload\\63ae2510ae2c11e6be0c12c967dbb02e实验室设备管理系统详细功能.docx', '1', '\\upload\\7fc8a9f0ae2c11e6be0c12c967dbb02e1.jpg', null, '0', null, null, '2');
INSERT INTO `t_equipment` VALUES ('12', '办公', '0', '0', '20000', 'RRRRRRRRRRRRRRRRRRR', null, 'P700', 'LENOVO', '10', null, null, '0', null, null, '0', null, null, '2');
...
CREATE TABLE `t_project` (
  ...
  `vice_director_id` int(11) DEFAULT NULL,
  `isDelete` int(11) DEFAULT NULL,
  `charged_captain_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `t_project` VALUES ('1', '三调', null, null, null, null);
...
CREATE TABLE `t_staff` (
  ...
  `surveying_zone_id` int(11) DEFAULT NULL,
  `roles_id` varchar(20) DEFAULT NULL,
  `staff_status_id` int(11) DEFAULT NULL,
  `password` varchar(255) DEFAULT NULL,
  `is_audited` varchar(2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_foyvfbcktyutw83txjhgih7yy` (`roles_id`),
  KEY `FK_m7wymg0u0smtwgcy28l00p63j` (`staff_status_id`),
  CONSTRAINT `t_staff_ibfk_1` FOREIGN KEY (`staff_status_id`) REFERENCES `type_of_staff_status` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_staff
-- ----------------------------
INSERT INTO `t_staff` VALUES ('1', '王涛涛', '18602017023', '', '1', '1,4', '1', '666666', '1');
INSERT INTO `t_staff` VALUES ('2', '王英谋', '15986356055', '', '1', '5', '1', '666666', '1');
INSERT INTO `t_staff` VALUES ('3', '陈展鹏', '15018706903', null, '1', '5', '1', '666666', '0');
INSERT INTO `t_staff` VALUES ('8', '唐涛', '15914333294', '360726198811042635', '2', '9,11', '1', '042635', '1');
INSERT INTO `t_staff` VALUES ('11', '赵博', '18676885815', '', '2', '7', '1', '666666', '1');
INSERT INTO `t_staff` VALUES ('13', '雷雳', '18620798392', null, '3', '7', '1', '666666', '1');
INSERT INTO `t_staff` VALUES ('21', '宋康伟', '13620437509', null, '2', '8', '1', '666666', '1');
INSERT INTO `t_staff` VALUES ('22', '刘锦潮', '13927669943', null, '3', '8', '1', '666666', '1');
INSERT INTO `t_staff` VALUES ('23', '陈忠良', '13500009074', null, '4', '7', '1', '666666', '1');
...
-- ----------------------------
-- Table structure for t_surveying_zone
-- ----------------------------
DROP TABLE IF EXISTS `t_surveying_zone`;
CREATE TABLE `t_surveying_zone` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT NULL,
  `director_id` int(11) DEFAULT NULL,
  `vice_director_id` varchar(20) DEFAULT NULL,
  `isDelete` int(11) DEFAULT '0',
...
-- ----------------------------
-- Records of t_surveying_zone
-- ----------------------------
INSERT INTO `t_surveying_zone` VALUES ('1', '广州', null, '', '0', '广东省广州市天河区广州大道北伍仙桥街28号6栋', null, '1');
INSERT INTO `t_surveying_zone` VALUES ('2', '博罗', '11', '21', '0', '广东省惠州市博罗县罗阳街道金域华府13B栋1302', null, '3');
INSERT INTO `t_surveying_zone` VALUES ('3', '清远', '13', '22', '0', '广东省清远市清城区', null, '2');
INSERT INTO `t_surveying_zone` VALUES ('4', '连州', '23', null, '0', '广东省清远市连州市', null, '2');
