...
public class EquipmentAction extends ActionSupport implements ModelDriven<Equipment> {
	 ...
	 * 将设置状态的列表提取到环境中
	 */
	private void putStatusPagersIntoContext() {
		//获取设置状态的列表
		Pager<EquipmentStatus> equipmentStatusPagers = equipmentStatusService.getList(null);
		ActionContext.getContext().put("equipmentStatusPagers", equipmentStatusPagers);
	}
